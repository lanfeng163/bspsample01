 ...
 */
public class MurooListHeaderView extends FrameLayout {
    private static final String TAG = "MurooListHeaderView";
    //ListView头部的3种状态
    ...
    public MurooListHeaderView(Context context) {
        this(context, null);
    }

    public MurooListHeaderView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MurooListHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        mHeaderContent = View.inflate(getContext(), R.layout.muroo_list_header_view, null);
     ...
     */
    public void fullyHideSmoothToShow() {
    ...
    public void setState(int state) {
        switch (state) {
            ...
            case STATE_PULL_REFRESH://"下拉刷新"状态,需要显示箭头,隐藏加载圈,显示下拉刷新文字和最后刷新的时间,同时启动箭头动画
                ...
                mTvState.setText(R.string.muroo_list_str1);
                mTvTime.setText(getRefreshTime());
                //显示箭头朝下
            ...
            case STATE_RELEASE_REFRESH: //"释放后刷新"状态,需要显示箭头,隐藏加载圈,显示释放后刷新文字和最后刷新的时间,同时启动箭头动画
                ...
                mPbLoading.setVisibility(View.INVISIBLE);
                mTvTime.setVisibility(View.VISIBLE);
                mTvState.setText(R.string.muroo_list_str2);
                //启动一个箭头的由下到上逆时针旋转的动画
            ...
            case STATE_REFRESHING:
                ...
                mTvState.setText(R.string.muroo_list_str3);
                break;
        }
    ...
    private String getRefreshTime() {
        String strs = mSharedPreferences.getString("key_refresh_time", mDateFormat.format(new Date()));
        return  "前回検索時間：" + strs;
    }
